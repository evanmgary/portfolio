...
export default function DexTable(props){
    ...
    let tableElements = tableArray.map((id) => {
        ...
        <tr key={"data-"+ id} className="table-row">
            ...
            <td className="table-data img-col"><Link href={`/pokedex/pokemon/${id}/${generationNum}`}><Image src={`/images/sprites/${id}.png`} width="50" height="50" alt={allPokes[id].name}></Image></Link></td>
